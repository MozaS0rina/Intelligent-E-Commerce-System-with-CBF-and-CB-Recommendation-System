...
<?php
	if (isset($_GET['info']) && $_GET['info'] == 'ro') {
			...
			<div class="col_1_of_4 span_1_of_4">
						...
						<li><a href="#"><span>Advanced Search</span></a></li>
						<li><a href="#">Orders and Returns</a></li>-->
						<li><a href="contact.php"><span>Customer Support Center</span></a></li>
						</ul>
					</div>
				...
				<div class="col_1_of_4 span_1_of_4">
					<h4>Contact</h4>
						<ul>
							<li><span>Phone: 0259 436 022</span></li>
							<li><span>Email: marketing@lotus-center.ro</span></li>
						</ul>
						<!--<div class="social-icons">
							<h4>Follow Us</h4>
					   		  <ul>
			...
			<div class="copy_right">
				<p>&copy; 2025 Royal Radiance . All Rights Reserved  </p>
		   </div>
     </div>
